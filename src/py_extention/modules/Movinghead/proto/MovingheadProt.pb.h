...
#ifndef GOOGLE_PROTOBUF_INCLUDED_MovingheadProt_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_MovingheadProt_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_MovingheadProt_2eproto
...
struct TableStruct_MovingheadProt_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_MovingheadProt_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::MovingheadProt::DataPacket* Arena::CreateMaybeMessage<::MovingheadProt::DataPacket>(Arena*);
template<> ::MovingheadProt::SendCommand* Arena::CreateMaybeMessage<::MovingheadProt::SendCommand>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace MovingheadProt {

enum Command : int {
  COMMAND_NOOP = 0,
  COMMAND_MOVE_RIGHT = 1,
  COMMAND_MOVE_LEFT = 2,
  COMMAND_MOVE_UP = 3,
  COMMAND_MOVE_DOWN = 4,
  COMMAND_MOVE_NORMAL = 5,
  COMMAND_SET_STEP = 6,
...
constexpr Command Command_MAX = COMMAND_SET_STEP;
...
class DataPacket final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:MovingheadProt.DataPacket) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "MovingheadProt.DataPacket";
  }
  protected:
  ...
  void clear_state();
  ::MovingheadProt::State state() const;
  void set_state(::MovingheadProt::State value);
  private:
  ::MovingheadProt::State _internal_state() const;
  void _internal_set_state(::MovingheadProt::State value);
  public:

  // @@protoc_insertion_point(class_scope:MovingheadProt.DataPacket)
 private:
  class _Internal;
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_MovingheadProt_2eproto;
};
// -------------------------------------------------------------------

class SendCommand final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:MovingheadProt.SendCommand) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "MovingheadProt.SendCommand";
  }
  protected:
  ...
  void clear_command();
  ::MovingheadProt::Command command() const;
  void set_command(::MovingheadProt::Command value);
  private:
  ::MovingheadProt::Command _internal_command() const;
  void _internal_set_command(::MovingheadProt::Command value);
  public:
  ...
  // @@protoc_insertion_point(class_scope:MovingheadProt.SendCommand)
 private:
  class _Internal;
...
inline ::MovingheadProt::State DataPacket::_internal_state() const {
  return static_cast< ::MovingheadProt::State >(_impl_.state_);
}
inline ::MovingheadProt::State DataPacket::state() const {
  // @@protoc_insertion_point(field_get:MovingheadProt.DataPacket.state)
  return _internal_state();
}
inline void DataPacket::_internal_set_state(::MovingheadProt::State value) {
  
  _impl_.state_ = value;
}
inline void DataPacket::set_state(::MovingheadProt::State value) {
  _internal_set_state(value);
  // @@protoc_insertion_point(field_set:MovingheadProt.DataPacket.state)
}
...
inline const std::string& DataPacket::timestamp() const {
  // @@protoc_insertion_point(field_get:MovingheadProt.DataPacket.timestamp)
...
void DataPacket::set_timestamp(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.timestamp_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:MovingheadProt.DataPacket.timestamp)
}
inline std::string* DataPacket::mutable_timestamp() {
  std::string* _s = _internal_mutable_timestamp();
  // @@protoc_insertion_point(field_mutable:MovingheadProt.DataPacket.timestamp)
  return _s;
}
...
inline std::string* DataPacket::release_timestamp() {
  // @@protoc_insertion_point(field_release:MovingheadProt.DataPacket.timestamp)
...
inline void DataPacket::set_allocated_timestamp(std::string* timestamp) {
  ...
  // @@protoc_insertion_point(field_set_allocated:MovingheadProt.DataPacket.timestamp)
}
...
inline ::MovingheadProt::Command SendCommand::_internal_command() const {
  return static_cast< ::MovingheadProt::Command >(_impl_.command_);
}
inline ::MovingheadProt::Command SendCommand::command() const {
  // @@protoc_insertion_point(field_get:MovingheadProt.SendCommand.command)
  return _internal_command();
}
inline void SendCommand::_internal_set_command(::MovingheadProt::Command value) {
  
  _impl_.command_ = value;
}
inline void SendCommand::set_command(::MovingheadProt::Command value) {
  _internal_set_command(value);
  // @@protoc_insertion_point(field_set:MovingheadProt.SendCommand.command)
}
...
inline int32_t SendCommand::value() const {
  // @@protoc_insertion_point(field_get:MovingheadProt.SendCommand.value)
...
inline void SendCommand::set_value(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:MovingheadProt.SendCommand.value)
}
...
template <> struct is_proto_enum< ::MovingheadProt::Command> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::MovingheadProt::Command>() {
  return ::MovingheadProt::Command_descriptor();
}
template <> struct is_proto_enum< ::MovingheadProt::State> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::MovingheadProt::State>() {
  return ::MovingheadProt::State_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_MovingheadProt_2eproto
